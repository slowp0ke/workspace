package ru.spbstu.telematics.ivanov722.lab04.server;
...
public class ClientThread implements Runnable {
	...
	public void run() {
		try {
			...
			aMessage = new Message("server", client.getNickname()
					+ " connected");
			...
			while (aMessage.getText().equals("%exit%") == false) {
				aMessage = (Message) in.readObject();
				System.out.println(aMessage.getFrom() + ": "
						+ aMessage.getText());
